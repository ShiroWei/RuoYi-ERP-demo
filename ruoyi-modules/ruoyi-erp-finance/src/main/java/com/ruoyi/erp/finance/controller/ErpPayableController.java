...
public class ErpPayableController extends BaseController
{
    ...
    /**
     * 生成应付账款（内部接口，供采购服务 Feign 调用）
     */
    @PostMapping("/internal/payable")
    public AjaxResult generate(@RequestBody ErpPayable erpPayable)
    {
        return toAjax(payableService.generateErpPayable(erpPayable));
    }
