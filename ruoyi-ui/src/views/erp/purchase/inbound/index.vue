  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="860px" append-to-body>
      ...
      <div slot="footer" class="dialog-footer">
        <span class="el-form-item__label" style="margin-right: 16px">入库金额：{{ form.totalAmount }} 元</span>
...
<script>
import { listPurchaseInbound, getPurchaseInbound, delPurchaseInbound, addPurchaseInbound, updatePurchaseInbound } from "@/api/erp/purchase"
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (!this.form.items || this.form.items.length === 0) {
            this.$modal.msgWarning("请添加入库明细行")
            return
          }
