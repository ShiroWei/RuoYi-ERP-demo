...
start "ERP-Base"     cmd /k "call bin\run-modules-erp-base.bat"
start "ERP-Purchase" cmd /k "call bin\run-modules-erp-purchase.bat"
start "ERP-Sale"     cmd /k "call bin\run-modules-erp-sale.bat"
start "ERP-Stock"    cmd /k "call bin\run-modules-erp-stock.bat"
start "ERP-Finance"  cmd /k "call bin\run-modules-erp-finance.bat"
start "ERP-Prod"     cmd /k "call bin\run-modules-erp-production.bat"
start "ERP-Report"   cmd /k "call bin\run-modules-erp-report.bat"
